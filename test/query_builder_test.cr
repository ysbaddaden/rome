...
module Rome
  class Query::BuilderTest < Minitest::Test
    ...
    def test_where
      ...
      assert_equal [
        Query::Builder::Condition.new(:id, 1),
        Query::Builder::RawCondition.new("key LIKE ?", ["test%"] of Value),
        Query::Builder::RawCondition.new("value > ? AND value < ?", [10, 20] of Value),
      ], b5.conditions
    end
    ...
    def test_where_in
      ...
      assert_nil b1.conditions
      assert_equal [
        Query::Builder::Condition.new(:id, [1, 3, 4] of Value),
      ], b2.conditions
    end
    ...
    def test_where_not
      ...
      assert_equal [
        Query::Builder::Condition.new(:id, 12, not: true),
        Query::Builder::RawCondition.new("id > ?", [12345] of Value, not: true),
